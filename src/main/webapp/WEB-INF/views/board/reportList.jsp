...
<c:if test="${count>0}">
	...
	<c:forEach var="i" begin="${startPage}" end="${endPage}">
			...
			<li class="page-item active"><a class="page-link" href="reportBoard.board?pageNum=${i}">${i}</a></li>
			</c:when>
	...
	<c:if test="${endPage < pageCount}">
		<li class="page-item"><a class="page-link" href="reportBoard.board?pageNum=${startPage+pageBlock}">다음</a></li>
	</c:if>
	</ul>
	</div>
</c:if>
